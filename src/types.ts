...
export const DATA_LABELS: { [key in Language]: DataLabels } = {
  fr: {
    ...
    serviceBusy: "Le service OpenStreetMap est momentanément saturé. Votre connexion fonctionne. Réessayez, ou réduisez le rayon de recherche : une grande zone en ville est très lourde à traiter.",
  ...
  en: {
    ...
    serviceBusy: "The OpenStreetMap service is momentarily overloaded. Your connection is fine. Try again, or reduce the search radius: a wide area in a city is very heavy to process.",
  ...
  de: {
    ...
    serviceBusy: "Der OpenStreetMap-Dienst ist derzeit überlastet. Ihre Verbindung ist in Ordnung. Versuchen Sie es erneut oder verkleinern Sie den Suchradius.",
  ...
  it: {
    ...
    serviceBusy: "Il servizio OpenStreetMap è momentaneamente sovraccarico. La connessione funziona. Riprova, o riduci il raggio di ricerca.",
  ...
  es: {
    ...
    serviceBusy: "El servicio OpenStreetMap está momentáneamente saturado. Su conexión funciona. Inténtelo de nuevo o reduzca el radio de búsqueda.",
